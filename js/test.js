...
// */
// // var collectStrings=["线下支付","行走","共享单车","地铁购票","网络购票","网购火车票","生活缴费","ETC缴费","电子发票","绿色办公","咸鱼交易","预约挂号"];
...
// //  * @param noFindExit
// //  */
// // function clickByDesc(energyType: string,paddingY: number, noFindExit?: boolean, exceptionMsg?: string)  {
...
// //     tLog(`shuru:, ${energyType}, ${noFindExit}, ${exceptionMsg}`);
...
// //     var regex="/";
// //     Config.colllect_names.forEach(function (t,num) {
// //         if(num==0){
// //             regex+="(\\s*"+t+"$)";
// //         }else{
// //             regex+="|(\\s*"+t+"$)";
